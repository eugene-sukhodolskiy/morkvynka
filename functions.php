...
function my_theme_enqueue_styles() {
	...
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/bootstrap/bootstrap.min.css', array('style'), '1.0.0' );
	wp_enqueue_style( 'bootstrap-grid', get_template_directory_uri() . '/bootstrap/bootstrap-grid.min.css', array('bootstrap'), '1.0.0' );
	wp_enqueue_style( 'bootstrap-utilities', get_template_directory_uri() . '/bootstrap/bootstrap-utilities.min.css', array('bootstrap-grid'), '1.0.0' );
	wp_enqueue_style( 'all', get_template_directory_uri() . '/css/all.min.css', array('bootstrap-utilities'), '1.0.0' );
}
